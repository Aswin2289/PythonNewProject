    ...
    <nav className="bg-white shadow">
      <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize ">
        <ul className="flex mr-12">
          <li className="text-gray-800  border-b-2 active:border-blue-500  mx-6">
            <NavLink to="/">Home</NavLink>
          </li>
          <li className=" border-transparent hover:text-gray-800 active:border-b-2 active:border-blue-500  hover:border-blue-500 mx-6">
